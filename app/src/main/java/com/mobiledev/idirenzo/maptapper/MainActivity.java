...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClick(View view) {
        ...
        DownloadManager.Request request_for_url = new DownloadManager.Request(
                Uri.parse("http://fc03.deviantart.net/fs14/i/2007/086/9/1/Steve_Jobs_portrait_by_tumb.jpg"));

        DownloadManager.Request request_for_url1 = new DownloadManager.Request(
                Uri.parse("http://2.bp.blogspot.com/_q7Rxg4wqDyc/S5ZRVLxVYuI/AAAAAAAAAvU/fQAUZ2XFcp8/s400/katrina-kaif.jpg"));
        DownloadManager.Request request_for_url2 = new DownloadManager.Request(
